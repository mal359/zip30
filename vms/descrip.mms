...
#    Zip.  These builders (and some source-code changes) add support
#    to Zip 3.0 for the x86_64 hardware architecture (and IA64-x86_64
#    cross tools).
#
...
#    for "XXX", below.)
#
#    SUPPORT FOR OPTIONAL BZIP2 COMPRESSION IS ENABLED BY DEFAULT, and a
#    suitable bzip2 source kit is supplied in this kit.  This was not
#    done in the original Zip 3.0 kit.  IF SUPPORT FOR BZIP2
...
#
#----------------------------------------------------------------------
# Copyright (c) 1998-2022 Info-ZIP.  All rights reserved.
#
...
#                   On Alpha, by default, large-file support is tested,
#                   and the build will fail if that test fails.
#                   Specify NOLARGE=1 explicitly to disable support (and
#                   to skip the test on Alpha).
#
#XXX    LIBZIP=1       Build LIBIZZIP.OLB as a callable Zip library.
#
